...
public class SalesActivityResource {
    ...
    private ResponseEntity<?> getRecordsV1(String type, Long start, Long end) {
        ...
        List<SalesActivityDTO> salesActivityDTOs = parkingSaleActivities.stream().map(parkingSaleActivity -> SalesActivityUtil.constructDTO(parkingSaleActivity, parkingSaleActivity.getActivityHolder()))
